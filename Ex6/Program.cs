...
namespace Ex6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] posicaoColuna1 = new int[4];
            int[] posicaoColuna2 = new int[4];
            int[] posicaoColuna3 = new int[4];
            ...
            for (int linhas = 1; linhas < matriz.GetLength(0); linhas++)
            {
                ...
                {
                    posicaoColuna1[linhas] = matriz[linhas, colunas];

                    if (posicaoColuna1[linhas] != 0)
                        zeroColuna1 = false;
                }
            }
            ...
            for (int linhas = 2; linhas < matriz.GetLength(0); linhas++)
            {
                ...
                {
                    posicaoColuna2[linhas] = matriz[linhas, colunas];

                    if (posicaoColuna2[linhas] != 0)
                        zeroColuna2 = false;
                }
            }
            ...
            for (int linhas = 3; linhas < matriz.GetLength(0); linhas++)
            {
                ...
                {
                    posicaoColuna3[linhas] = matriz[linhas, colunas];

                    if (posicaoColuna3[linhas] != 0)
                        zeroColuna3 = false;
                }
            }
